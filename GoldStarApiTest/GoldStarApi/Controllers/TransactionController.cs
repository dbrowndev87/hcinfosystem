 ...
 * Description: This is the controller for the Transaction interface. This controller is modeled after the Transaction database
 *     table. It will house all of the API end points for interactions with transaction objects. The basic GET, POST,

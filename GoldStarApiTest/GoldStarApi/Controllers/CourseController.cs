 ...
 * Description: This is the controller for the Course interface. This controller is modeled after the Course database
 *     table. It will house all of the API end points for interactions with course objects. The basic GET, POST,

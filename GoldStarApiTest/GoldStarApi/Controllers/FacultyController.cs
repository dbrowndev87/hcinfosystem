 ...
 * Description: This is the controller for the Faculty interface. This controller is modeled after the Faculty database
 *     table. It will house all of the API end points for interactions with faculty objects. The basic GET, POST,

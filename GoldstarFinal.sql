...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 23, 2019 at 07:43 PM
...
(
  `faculty_id` int
(6) NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `faculty_status` varchar
(20) NOT NULL,
  `user_id` int
(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
DELIMITER $$
CREATE TRIGGER `update_amount_owing` AFTER
INSERT ON `transaction` FOR
EACH
ROW
UPDATE student
...
INSERT INTO `user`
  (`user_id`, `first_name
  `, `last_name`, `email`, `birth_date`, `type_code`, `address`, `dept_id`) VALUES
(1, 'Darcy', 'Brown', 'dbrown32066@hollandcollege.com', '2019-03-18', 1, '8 Bonnie Blink Dr.', 1),
(2, 'darcy2', 'brown', 'asdasdasd', '2019-01-03', 2, '8 bonnie blink dr.', 1),
(3, 'nicholas', 'peconi', 'asdasd', '2019-01-11', 1, 'asdasd', 1);
...
username`,
`password
`, `active`, `user_id`) VALUES
('dbrown32066', '5f4dcc3b5aa765d61d8327deb882cf99', 1, 1),
('dbrown8218', 'e30bd39aa5e4a2c40efffd16b189dd60', 1, 2),
('npeconi143', '5f4dcc3b5aa765d61d8327deb882cf99', 1, 3);
...
--
ALTER TABLE `course`
ADD CONSTRAINT `course_ibfk_1` FOREIGN KEY
...
--
ALTER TABLE `enrollment`
ADD CONSTRAINT `enrollment_ibfk_1` FOREIGN KEY
(`student_id`) REFERENCES `student`
(`student_id`),
ADD CONSTRAINT `enrollment_ibfk_2` FOREIGN KEY
...
--
ALTER TABLE `section`
ADD CONSTRAINT `section_ibfk_1` FOREIGN KEY
(`faculty_id`) REFERENCES `faculty`
(`faculty_id`),
ADD CONSTRAINT `section_ibfk_2` FOREIGN KEY
...
(`type_code`) REFERENCES `user_type_code`
(`type_code`);
COMMIT;
